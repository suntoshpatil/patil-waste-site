...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="hero-section" style={{ minHeight:'calc(100vh - 57px)', background:'var(--black)', position:'relative', overflow:'hidden', display:'flex', alignItems:'center', padding:'5rem 2.5rem', paddingTop:'calc(57px + 5rem)' }}>
        ...
        <div className="hero-inner" style={{ maxWidth:'1100px', margin:'0 auto', width:'100%', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'3rem' }}>
        ...
        <div className="hero-stats" style={{ position:'absolute', bottom:'2.5rem', left:'50%', transform:'translateX(-50%)', display:'flex', gap:'3rem' }}>
      ...
      <section className="section" style={{ background:'var(--cream)' }}>
        <div className="section-inner" style={{ textAlign:'center' }}>
          ...
          <div className="mobile-stack" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1.5rem', maxWidth:'720px', margin:'0 auto 2rem' }}>
      ...
      <section className="section" style={{ background:'var(--white)' }}>
        <div className="section-inner" style={{ textAlign:'center' }}>
          ...
          <div className="mobile-stack" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'2rem' }}>
