    ...
    <>
      ...
      {open && (
        <div
          ...
          style={{ position:'fixed', inset:0, background:'#0d0d0d', zIndex:490, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:'1.75rem', paddingTop:'72px', paddingBottom:'2rem', overflowY:'auto' }}
        >
